-- =============================================
-- Flyway Migration: V2__insert_keywords.sql
-- Insert Master Keywords Data
-- =============================================

-- =============================================
-- 1. 공간 유형 (SPACE_TYPE) 키워드 - 10개
-- =============================================
...
-- =============================================
-- 2. 악기/장비 (INSTRUMENT_EQUIPMENT) 키워드 - 15개
-- =============================================
INSERT INTO keywords (name, type, description, display_order, is_active)
