...
-- =============================================
INSERT INTO keywords (name, type, description, display_order, is_active) VALUES
    ('합주실', 'SPACE_TYPE', '밴드 합주를 위한 전용 공간', 1, true),
...
-- =============================================
INSERT INTO keywords (name, type, description, display_order, is_active) VALUES
    ('주차 가능', 'AMENITY', '자체 주차장 또는 인근 주차 가능', 26, true),
...
-- =============================================
INSERT INTO keywords (name, type, description, display_order, is_active) VALUES
    ('저렴한 가격', 'OTHER_FEATURE', '합리적인 가격대', 41, true),
